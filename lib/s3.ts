...
function resolveAwsConfig(): AwsConfig {
    ...
    const accessKeyIdRaw = process.env.AWS_ACCESS_KEY_ID ?? process.env.AWS_ACCESS_KEY ?? "";
    const secretAccessKeyRaw = process.env.AWS_SECRET_ACCESS_KEY ?? process.env.AWS_SECRET_KEY ?? "";
